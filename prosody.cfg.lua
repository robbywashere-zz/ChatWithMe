...
--FG_SOURCEDIR='/opt/local/lib/prosody';
--CFG_CONFIGDIR='/opt/local/etc/prosody';
--CFG_PLUGINDIR='/opt/local/lib/prosody/modules/';
--CFG_DATADIR='/opt/local/var/lib/prosody';
